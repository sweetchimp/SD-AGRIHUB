  ...
  return (
    <div className="grid grid-cols-3 gap-4">
      <div className="bg-gradient-to-br from-primary to-green-600 text-white rounded-lg p-6 shadow-md">
        ...
        <p className="text-3xl font-bold mt-2">{totalProduction.toLocaleString()} UGX</p>
      </div>
      ...
      <div className={`bg-gradient-to-br ${profit >= 0 ? "from-accent to-yellow-600" : "from-gray-400 to-gray-600"} text-white rounded-lg p-6 shadow-md`}>
