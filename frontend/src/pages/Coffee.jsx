                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8 border-l-4 border-accent">
                  ...
                  <form onSubmit={handleFieldSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="flex items-end gap-2">
                      ...
                      {editingField && (
                        <button type="button" onClick={handleCancelField} className="px-4 py-2 bg-gray-400 text-white rounded-lg hover:bg-gray-500">
                          Cancel
                        </button>
                      )}
                    </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8 border-l-4 border-accent">
                  ...
                  <form onSubmit={handleActivitySubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="flex items-end gap-2">
                      ...
                      {editingActivity && (
                        <button type="button" onClick={handleCancelActivity} className="px-4 py-2 bg-gray-400 text-white rounded-lg hover:bg-gray-500">
                          Cancel
                        </button>
                      )}
                    </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8 border-l-4 border-accent">
                  ...
                  <form onSubmit={handleHarvestSubmit} className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="flex items-end gap-2">
                      ...
                      {editingHarvest && (
                        <button type="button" onClick={handleCancelHarvest} className="px-4 py-2 bg-gray-400 text-white rounded-lg hover:bg-gray-500">
                          Cancel
                        </button>
                      )}
                    </div>
